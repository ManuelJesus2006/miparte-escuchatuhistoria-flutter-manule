...
import 'package:escucha_tu_historia_front/core/utils/ui_utils.dart';
import 'package:escucha_tu_historia_front/features/monuments/presentation/widgets/empty_monuments_widget.dart';
import 'package:escucha_tu_historia_front/features/monuments_routes/presentation/widgets/card_ruta.dart';
import 'package:escucha_tu_historia_front/features/monuments_routes/providers/rutas_provider.dart';
...
class _RutasScreenState extends State<RutasScreen> {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _searchBarWidget(context, rutasProvider, localizations),
                        const SizedBox(height: 20),
                        ...
                        _aiBannerWidget(context, localizations),
                        const SizedBox(height: 24),

                        // Lista de rutas filtradas
                        _rutasListWidget(rutasProvider, localizations),
                      ],
                    ),
                  ),
                ),
  ...
  Widget _searchBarWidget(
    ...
    return SearchBar(
      hintText: localizations?.routes_search_input_label ?? 'Buscar ruta...',
        ...
        children: rutasProvider.tagsRutas.map((tag) {
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              child: Text(
                UIUtils.translateRouteTag(tag, localizations!),
                style: TextStyle(
                  color: isSelected
                      ? Colors.white
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    localizations?.routes_ai_question ??
                        '¿Qué quieres ver hoy?',
                  ...
                  const SizedBox(height: 4),
                  Text(
                    localizations?.routes_ai_description ??
